...
- **S** = Stack (8) — the inside two receivers stack one behind the other, X still
  on the line outside. Attached (`18S`); `14 S` with a space is the Split tag.
...
- 3 backs: **KI** / **QI** King I and Queen I (two fullbacks side by side, second
  one offset to strength or away from it, tailback behind them) · **S2G** / **W2G** two-up gun strong/weak · **K2G** / **Q2G** the King and
